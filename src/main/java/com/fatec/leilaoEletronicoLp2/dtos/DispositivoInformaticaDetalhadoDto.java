...
public class DispositivoInformaticaDetalhadoDto {
	
	public DispositivoInformaticaDetalhadoDto(Integer diId, String diEnderecoFisico, String diMarca, String diProcessador,
